(function ($) {
  ...
  function populateDraftFromWindowDetail(detail) {
    ...
    d.acceptDone = detail.acceptDone || "";
  ...
  function bindScheduleVersionWindowForm() {
    ...
    function updateScheduleCreateDraftField(field, value) {
      ...
      if (field === "start" || field === "planTestDone" || field === "testDone" || field === "acceptDone") {
    ...
    form.addEventListener("input", function (e) {
      var target = e.target;
      if (target && target.name && target.name !== "productIds") {
        updateScheduleCreateDraftField(target.name, target.value);
      }
    });
  ...
  function submitScheduleWindowRequest(method, url, payload) {
    return scheduleRequestFetch(url, {
      ...
      body: JSON.stringify({
        ...
        windowType: payload.windowType || "regular",
        planTestDone: payload.planTestDone || "",
        testDone: payload.testDone || "",
        acceptDone: payload.acceptDone || "",
