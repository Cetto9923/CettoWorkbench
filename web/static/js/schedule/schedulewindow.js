  ...
  function bindScheduleVersionWindowForm() {
    ...
    function updateScheduleCreateDraftField(field, value) {
      ...
      if (field === "start") {
        d._startManual = true;
        d._startAutoGenerated = false;
        draftApi.syncPlanBeginFromWindow(d);
        refreshUI();
        return;
      }
      if (field === "name") {
    ...
    form.addEventListener("change", function (e) {
      ...
      if (target.id === "scheduleWindowUseOrgTemplate") {
        var draft = draftApi.getDraft();
        draft.useOrgTemplate = !!target.checked;
        if (draft.useOrgTemplate) {
          draftApi.applyOrgTemplateDates();
        }
        refreshUI();
        return;
      }
